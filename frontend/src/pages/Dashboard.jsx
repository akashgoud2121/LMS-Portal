...
import { FaBook, FaQuestionCircle, FaClock, FaTrophy, FaChartLine, FaGraduationCap, FaArrowRight } from 'react-icons/fa';
const Dashboard = () => {
    ...
    const fetchEnrollments = async () => {
        try {
            ...
            const uniqueEnrollments = normalizedEnrollments.filter((e) => {
            ...
            const courseIds = uniqueEnrollments.map((e) => e.course._id);
            ...
            const attemptPromises = allQuizzes.map(async (quiz) => {
                try {
                    ...
                    // No attempts yet or error - that's okay
                }
                return null;
            });
    ...
    return (<div className="flex min-h-screen bg-gray-50">
      ...
      <div className="flex-1 ml-64 p-8">
        <div className="max-w-7xl mx-auto">
          ...
          {enrollments.length === 0 ? (<div className="bg-white rounded-2xl shadow-sm p-12 text-center border border-gray-100 hover:shadow-xl hover:border-blue-200 transition-all duration-300">
              <div className="mb-6">
              ...
              <Link to="/courses" className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-8 py-3 rounded-xl hover:from-blue-700 hover:to-indigo-700 transition-all duration-300 hover:scale-105 active:scale-95 shadow-lg hover:shadow-xl font-medium">
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <Link to="/student/courses" className="flex items-center gap-3 p-4 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors group">
                  ...
                  <Link to="/student/watch-lessons" className="flex items-center gap-3 p-4 bg-purple-50 rounded-lg hover:bg-purple-100 transition-colors group">
                  ...
                  <Link to="/student/attempt-quizzes" className="flex items-center gap-3 p-4 bg-indigo-50 rounded-lg hover:bg-indigo-100 transition-colors group">
              ...
              {/* Quizzes Section */}
              {quizzes.length > 0 && (<div className="mb-8">
                  <div className="flex items-center justify-between mb-6">
                    ...
                    <Link to="/student/attempt-quizzes" className="text-blue-600 hover:text-blue-700 font-medium text-sm flex items-center gap-2">
                      View All
                      <FaQuestionCircle />
                    </Link>
                  </div>
                    ...
                    {quizzes.slice(0, 3).map((quiz) => {
                        ...
                        <div className="p-6">
                          ...
                          <div className="flex items-center gap-4 mb-4 text-sm text-gray-600">
                            {quiz.timeLimit > 0 && (<div className="flex items-center gap-1">
                          ...
                          {hasAttempted && (<div className={`mb-4 p-3 rounded-lg ${attempt.passed
                          ...
                          <Link to={`/courses/${quiz.course?._id}/quiz/${quiz._id}`} className={`block w-full text-center px-4 py-3 rounded-xl transition-all duration-300 hover:scale-105 active:scale-95 shadow-md hover:shadow-lg font-medium ${hasAttempted
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {enrollments.map((enrollment) => (<div key={enrollment._id} className="bg-white rounded-2xl shadow-sm overflow-hidden border border-gray-100 hover:shadow-2xl hover:scale-[1.02] hover:border-blue-200 transition-all duration-300 group cursor-pointer">
                  {enrollment.course.thumbnail && (<div className="relative overflow-hidden">
                      <img src={getImageUrl(enrollment.course.thumbnail)} alt={enrollment.course.title} className="w-full h-48 object-cover group-hover:scale-110 transition-transform duration-700" onError={(e) => {
                  ...
                  <div className="p-6">
                    ...
                    <div className="mb-5">
                      ...
                      <div className="w-full bg-gray-200 rounded-full h-2.5 overflow-hidden shadow-inner">
                        <div className="bg-gradient-to-r from-blue-500 via-indigo-500 to-blue-600 h-2.5 rounded-full transition-all duration-700 group-hover:shadow-lg group-hover:shadow-blue-500/50" style={{ width: `${enrollment.progress}%` }}></div>
                      </div>
                    </div>

                    <Link to={`/courses/${enrollment.course._id}`} className="block w-full text-center bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-4 py-3 rounded-xl hover:from-blue-700 hover:to-indigo-700 transition-all duration-300 hover:scale-105 active:scale-95 shadow-md hover:shadow-lg font-medium">
