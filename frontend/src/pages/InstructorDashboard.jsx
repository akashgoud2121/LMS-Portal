...
import { FaBook, FaUsers, FaGraduationCap, FaChartLine, FaPlusCircle, FaTrophy, FaLightbulb, FaArrowRight, FaCheckCircle, FaQuestionCircle, FaChartBar, FaFire } from 'react-icons/fa';
    ...
    const fetchDashboardData = async () => {
        try {
            ...
            try {
                ...
                uniqueStudentsCount = coursesData.reduce((sum, c) => sum + (c.enrolledStudents || 0), 0);
            }
        ...
        <div className="bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 text-white py-12 w-full">
          <div className="px-8">
            <div className="flex items-center justify-between">
              ...
              <Link to="/instructor/courses/create" className="bg-white text-indigo-600 px-6 py-3 rounded-lg font-semibold hover:bg-indigo-50 transition-all duration-300 shadow-lg flex items-center gap-2">
                <FaPlusCircle />
                Create Course
              </Link>
            </div>
              ...
              <div className="lg:col-span-2 space-y-6">
                ...
                <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                  <div className="flex items-center justify-between mb-6">
                    ...
                    <Link to="/instructor/courses" className="text-indigo-600 hover:text-indigo-700 text-sm font-medium flex items-center gap-1">
                      View All
                      <FaArrowRight className="text-xs"/>
                    </Link>
                  </div>
                  <div className="grid grid-cols-2 gap-4">
          <Link to="/instructor/courses/create" className="group p-5 bg-gradient-to-br from-indigo-50 to-indigo-100 rounded-lg hover:from-indigo-100 hover:to-indigo-200 transition-all duration-200 border border-indigo-200">
                    ...
                    <Link to="/instructor/quizzes/create" className="group p-5 bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg hover:from-purple-100 hover:to-purple-200 transition-all duration-200 border border-purple-200">
                      <div className="flex items-center gap-3 mb-2">
                    ...
                    <Link to="/instructor/materials" className="group p-5 bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg hover:from-blue-100 hover:to-blue-200 transition-all duration-200 border border-blue-200">
                      <div className="flex items-center gap-3 mb-2">
                    ...
                    <Link to="/instructor/quizzes" className="group p-5 bg-gradient-to-br from-green-50 to-green-100 rounded-lg hover:from-green-100 hover:to-green-200 transition-all duration-200 border border-green-200">
                      <div className="flex items-center gap-3 mb-2">
                ...
                <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                  ...
                  {recentCourses.length === 0 ? (<div className="text-center py-8">
                      <FaBook className="text-4xl text-gray-300 mx-auto mb-3"/>
                      <p className="text-gray-500 text-sm mb-4">No courses yet</p>
            <Link to="/instructor/courses/create" className="inline-flex items-center gap-2 bg-indigo-600 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-indigo-700 transition-colors">
                        <FaPlusCircle />
                        Create Course
            </Link>
          </div>) : (<div className="space-y-3">
                      {recentCourses.map((course) => (<Link key={course._id} to={`/instructor/courses/${course._id}/edit`} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg hover:bg-indigo-50 border border-transparent hover:border-indigo-200 transition-all duration-200 group">
                          <div className="flex items-center gap-4">
                            <div className={`p-2 rounded-lg ${course.isPublished
                    ...
                    : 'bg-gray-200 text-gray-600'}`}>
                            ...
                            <div>
                              ...
                              <div className="flex items-center gap-3 text-xs text-gray-500">
                                ...
                                <span className={`px-2 py-0.5 rounded text-xs font-medium ${course.isPublished
              ...
              <div className="space-y-6">
                  ...
                  <div className="space-y-6">
                    <div>
                      ...
                      <div className="w-full bg-gray-100 rounded-full h-2">
                        <div className="bg-green-600 h-2 rounded-full transition-all duration-500" style={{ width: `${stats.completionRate}%` }}></div>
                      </div>
                    ...
                    <div>
                      ...
                      <div className="w-full bg-gray-100 rounded-full h-2">
                        <div className="bg-blue-600 h-2 rounded-full transition-all duration-500" style={{ width: `${stats.averageProgress}%` }}></div>
                      </div>
                      <p className="text-xs text-gray-500 mt-1">
                ...
                <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                  <div className="flex items-center justify-between mb-6">
                    ...
                    <Link to="/instructor/quizzes" className="text-indigo-600 hover:text-indigo-700 text-xs font-medium">
                      View All
                    </Link>
                  </div>
