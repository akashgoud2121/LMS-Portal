...
const AdminDashboard = () => {
    ...
    return (<AdminLayout>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
        <div className="bg-white border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow cursor-pointer" onClick={() => navigate('/admin/users')}>
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow cursor-pointer" onClick={() => navigate('/admin/courses')}>
          <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center gap-2 mt-2">
            <div className="flex-1 bg-gray-200 rounded-full h-1.5">
              <div className="bg-purple-600 h-1.5 rounded-full" style={{ width: `${publishedPercentage}%` }}></div>
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-6">
          ...
          {enrollmentChartData.length > 0 ? (<ResponsiveContainer width="100%" height={280}>
              <LineChart data={enrollmentChartData}>
                ...
                <Line type="monotone" dataKey="enrollments" stroke="#6366f1" strokeWidth={3} dot={{ fill: '#6366f1', r: 4 }} activeDot={{ r: 6 }}/>
              </LineChart>
            </ResponsiveContainer>) : (<div className="flex items-center justify-center h-[280px] border-2 border-dashed border-gray-200 rounded-lg">
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-6">
          ...
          {userGrowthChartData.length > 0 ? (<ResponsiveContainer width="100%" height={280}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-white border border-gray-200 rounded-lg">
          ...
          <div className="p-6">
            {analytics.recentEnrollments.length === 0 ? (<div className="text-center py-12">
                ...
                {analytics.recentEnrollments.slice(0, 5).map((enrollment) => (<div key={enrollment.id} className="flex items-center justify-between py-3 border-b border-gray-100 last:border-0">
          ...
          {analytics.recentEnrollments.length > 5 && (<div className="border-t border-gray-200 px-6 py-3 bg-gray-50">
              <button onClick={() => navigate('/admin/users')} className="text-sm text-blue-600 hover:text-blue-700 font-medium">
                View all activity →
              </button>
            </div>)}
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-lg">
          ...
          <div className="border-t border-gray-200 px-6 py-4 bg-gray-50">
            <button onClick={() => navigate('/admin/approvals')} className="w-full bg-blue-600 text-white text-sm font-medium py-2 px-4 rounded-lg hover:bg-blue-700 transition-colors">
              Review Approvals
            </button>
          </div>
        </div>
