...
const RegisterInstructor = () => {
  ...
  if (success) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-600 to-green-800 py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-md w-full space-y-8 bg-white rounded-lg shadow-xl p-8">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            Create your instructor account (requires admin approval)
          </p>
        </div>
        ...
        <div className="text-center space-y-2">
          <p className="text-sm text-gray-600">
            ...
            <Link to="/instructor/login" className="text-green-600 hover:text-green-500 font-medium">
              Sign in
            </Link>
          </p>
